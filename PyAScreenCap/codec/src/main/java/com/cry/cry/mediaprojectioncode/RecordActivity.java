...
//    String url = "rtmp://169.254.8.220/live/STREAM_NAME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        width = Integer.valueOf(intent.getStringExtra("w"));
        height = Integer.valueOf(intent.getStringExtra("h"));
        Toast.makeText(RecordActivity.this, url + width + height, Toast.LENGTH_LONG).show();
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RecordActivity.this, width + "x" + height, Toast.LENGTH_LONG).show();
